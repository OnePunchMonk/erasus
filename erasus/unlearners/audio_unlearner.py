"""
Audio Unlearner — Orchestrator for Audio Model (Whisper) unlearning.

Example::

    from erasus.unlearners import AudioUnlearner

    unlearner = AudioUnlearner(model=whisper_wrapper.model)
...
class AudioUnlearner(BaseUnlearner):
    """
    Unlearner specialised for Audio Models (Whisper).
    """
